...
filename=sys.argv[1]; #file name of the G code commands

GPIO.setmode(GPIO.BOARD)
			
MX=Bipolar_Stepper_Motor(13,15,21,23);     #pin number for a1,a2,b1,b2.  a1 and a2 form coil A; b1 and b2 form coil B

MY=Bipolar_Stepper_Motor(32,36,38,40);       
#                        22,24,7,5
Laser_switch=26;
